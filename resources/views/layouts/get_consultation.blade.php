...
<section id="call-to-action" class="wow fadeInUp" dir="{{App::getLocale()=='en' ? 'auto': 'rtl'}}">
        <div class="container">
          <div class="row">
            <div class="col-md-9 text-center text-lg-left">
              <p class="cta-title">{{trans('home.quote')}}</p>
            </div>
            <div class="col-md-3 cta-btn-container text-center">
              <a href="#"  class="cta-btn align-middle" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#getConsultation">{{trans('home.second')}}</a>
              <div class="modal" id="getConsultation" tabindex="-1" role="dialog" aria-labelledby="getConsultationTitle" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="card" style="border:0px">
                                <article class="card-body">
                                    <h4 class="card-title text-center mb-4 mt-1">{{trans('home.second')}}</h4>
                                    <hr>
                                    <form class="form" role="form" action="{{route('post.consultation')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                                <div class="input-group">
                                                <textarea name="description" placeholder="{{trans('home.description')}}" class="form-control rounded-0" rows="4" required=""></textarea>
                                                </div> <!-- input-group.// -->
                                            </div>
                                         <div class="form-group">
                                             <button type="submit" class="btn btn-primary btn-block rounded-0">{{trans('home.second')}}</button>
                                         </div>
                                     </form>
                                    <hr>
                                </article>
